...
public class ShipEntity extends PhysicsEntity {


	public static final CogaenId TYPE = new CogaenId("Ship");
	...
	public ShipEntity(Core core, CogaenId id) {
		super(core, id, TYPE, RADIUS);
		
		addComponent(new MotionComponent(BodyAttrId));
		addComponent(new ControllerComponent(NUM_BUTTONS));
