...
public class SmallAsteroidRepresentation extends BaseRepresentation {
	...
	public SmallAsteroidRepresentation(Core core, CogaenId entityId) {
		super(core, entityId);
	}
	...
	public void engage() {
		...
		SpriteVisual visual = (SpriteVisual) ResourceService.getInstance(getCore()).getResource("SmallAsteroidSpr");
...
//		getNode().addVisual(debugVisual);
	...
	public void destroy() {
		...
		sndSrv.playFromPool(PlayView.SOUND_SMALL_EXPLOSION_POOL);
	}
